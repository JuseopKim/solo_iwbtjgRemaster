...
HRESULT effectTest::init()
{
	...
	EFFECTMANAGER->addEffect("explosion", "explosion.bmp", 832, 62, 32, 62, 1.0f, 1.0f, 300);
...
void effectTest::update() 
{
	...
	if (_count % 10 == 0)
	{
		EFFECTMANAGER->play("explosion", RND->getFromIntTo(100, 300), RND->getFromIntTo(100, 300));
	}
